...
//insert data into ArrayList result
    ...
    public boolean deletePlat(int id){
     String url = Statics.BASE_URL+"/DeletePlatsjson?id="+id;
        ...
        String url =Statics.BASE_URL+"/AddPlatsjson/new?nom="+plat.getNom()+"&prix="+plat.getPrix()+"&desc="+plat.getDescription()+"&calories="+plat.getCalories()+"&etat="+plat.getEtat()+"&nbp="+plat.getNbp()+"&image="+plat.getImage()+"&user="+plat.getUser_id(); // aa sorry n3adi getId lyheya mech ta3 user ta3 reclamation
