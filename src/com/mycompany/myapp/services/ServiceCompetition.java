...
import com.mycompany.myapp.entities.competition;
import static com.mycompany.myapp.services.ServiceCompetition.resultOk;
...
public class ServiceCompetition {
    ...
    public void AjouterCompetition(competition competition){
        ...
        String url=Statics.BASE_URL+"competition/newJson?nomCompetition="+competition.getNomCompetition()
 ...
 public ArrayList<competition> AfficherCompetition() {
    ...
    String url = Statics.BASE_URL + "competition/CompetitionsJson";
    req.setUrl(url);
        ...
        public void actionPerformed(NetworkEvent evt) {
            ...
            try {
                ...
                for (Map<String, Object> obj : listOfMaps) {
                    ...
                    int nbrParticipant = ((Double) obj.get("nbrParticipant")).intValue();
                    ...
                    c.setNbrParticipant(String.valueOf(nbrParticipant));
    ...
    public competition DetailCompetition(int id, competition cmp){
        String url= Statics.BASE_URL+"competition/"+id+"/json/";
...
req.addResponseListener((evt)->{
    ...
    public boolean SupprimerCompetition(int id ) {
        String url = Statics.BASE_URL +"competition/deleteJson/"+id;
    ...
    public boolean ModifierCompetition(competition cmp) {
        String url = Statics.BASE_URL +"competition/editJson/"+cmp.getIdCompetition()+"?nomCompetition="+cmp.getNomCompetition()+
