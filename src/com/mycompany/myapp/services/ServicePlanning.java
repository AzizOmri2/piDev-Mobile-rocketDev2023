...
public class ServicePlanning {
    ...
    public void AjouterPlanning(Planning planning){
        ...
        String url=Statics.BASE_URL+"planning/newJSON?datePlanning="+planning.getDatePlanning()+
    ...
    public ArrayList<Planning>AfficherPlanning(){
        ...
        String url =Statics.BASE_URL+"planning/viewJSON";
        req.setUrl(url);
    ...
    public boolean SupprimerPlanning(int id ) {
        String url = Statics.BASE_URL +"planning/deleteJSON/"+id;
    ...
    public boolean ModifierPlanning(Planning p) {
        String url = Statics.BASE_URL +"planning/editJSON/"+p.getId()+
