...
import static com.mycompany.myapp.services.ServiceTicket.resultOk;
...
public class ServiceTicket {
    ...
    public void AjouterTicket(Ticket ticket){
        ...
        String url=Statics.BASE_URL+"ticket/newJson?descriptionTicket="+ticket.getDescription();                
...
public ArrayList<Ticket> AfficheTicket() {
    ...
    String url = Statics.BASE_URL + "ticket/json";
    req.setUrl(url);
  ...
  public Ticket DetailTicket(int id, Ticket t){
        String url= Statics.BASE_URL+"ticket/"+id+"/json/";
...
req.addResponseListener((evt)->{
    ...
    public boolean SupprimerTicket(int id ) {
        String url = Statics.BASE_URL +"ticket/"+id+"/deleteJson";
        ...
        String url = Statics.BASE_URL +"ticket/editJson/"+tck.getId()+"?descriptionTicket="+tck.getDescription();
        req.setUrl(url);
